...
class Autho {
  ...
  Future signUp({required String first_name,
  ...
  Future sendEmail(String email ) async {
    ...
    String link = "https://sinbadslunch.com/myBackENd/PHPMailer-master/new_php_mail/index.php";
    var res = await http.post(Uri.parse(link),
        body: {
          "email":email,
        }
...
print(res.body.toString());
  ...
  Future  logIn({required String email, required String password} ) async {
    ...
    if(data!="Please verify your information !!!") {
    print(data);
