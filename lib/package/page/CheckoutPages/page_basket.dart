...
class _PageBasketState extends State<PageBasket> {
  ...
  void initState() {
    ...
    Timer(  Duration(seconds: duration), () async {
      if(compInfoDelt["date_time"] != null) {
        EasyLoading.dismiss();
        setState(() {
          duration=0;
        });
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  AStx(
                                      '\$${totalFood}', colr: ColorsApp.blak50),
                              ...
                              Flexible(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Flexible(
                                        child: AStx(
                                          'Company : ' +compInfoDelt["comp_name"].toString() ,
                                        )),
                                    Flexible(
                                      child: AStx(
                                        'Location : '+ compInfoDelt["comp_adderss"].toString(),
                                        MLin: 2,
                                      ),
                                    ),
                                  ],
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (itemsOrder.BasketListItems != null &&
                                          compInfoDelt['delivery_status'] ==
                                              'Open' &&
                                          itemsOrder.BasketListItems.length >
                                              0) {
                                        setMessage(context);
                                        Navigator.push(
                                            context,
